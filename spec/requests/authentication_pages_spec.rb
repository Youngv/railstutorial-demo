...
describe "Authentication" do
  ...
  describe "signin" do
    ...
    describe "invalid information" do
      ...
      describe "after visit home page" do
  ...
  describe "authorization" do
    ...
    describe "for non-signed-in users" do
      ...
      describe "visit the users page" do
    ...
    describe "as wrong user" do
      ...
      describe "submitting a PATCH request to the Users#patch action" do
